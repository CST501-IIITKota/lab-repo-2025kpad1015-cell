#1. To detect and diagnose common data issues, such as missing values, special values, outliers, inconsistencies, and localization
#2. Handling transformation
#3. Deductive correction, and Deterministic imputation
#4. Dimensional reduction
#5. Frequent patterns, and Sequence mining
#6. Calculating statistical significance
#7. Cluster analysis and
#8. Other common techniques
